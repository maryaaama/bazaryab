  ...
  return (
    <div className="bg-gradient-to-b from-[#020617] to-[#0a1a2f] text-white font-[Vazirmatn] min-h-screen">
      ...
      <section className="text-center pt-36 pb-6">
        <h1 className="sm:text-3xl text-xl font-bold text-cyan-300 mb-4">
          سامانه مدیریت و جستجوی آگهی
        </h1>
        <p className="font-[Vazirmatn] text-gray-200 sm:text-lg text-sm leading-relaxed sm:max-w-2xl w-3/5 mx-auto mb-4">
